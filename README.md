...
<head>
  ...
  <style>
    ...
    th:nth-child(1), td:nth-child(1) { width: 34px; }   /* 10% */
    th:nth-child(2), td:nth-child(2) { width: 102px; }  /* 30% */
    th:nth-child(3), td:nth-child(3) { width: 102px; }  /* 30% */
    th:nth-child(4), td:nth-child(4) { width: 102px; }  /* 30% */
